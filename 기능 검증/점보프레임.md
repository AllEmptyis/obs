...
- 결과
	- 처음엔 됐었는데 나중에는 안 됨
```
C:\Users\USER>ping -t 10.10.10.20 -f -l 1000

Ping 10.10.10.20 1000바이트 데이터 사용:
10.10.10.20의 응답: 바이트=1000 시간=3ms TTL=128
10.10.10.20의 응답: 바이트=1000 시간=2ms TTL=128
10.10.10.20의 응답: 바이트=1000 시간=3ms TTL=128

C:\Users\USER>ping -t 10.10.10.20 -f -l 3000

Ping 10.10.10.20 3000바이트 데이터 사용:
요청 시간이 만료되었습니다.

(원래 결과)
C:\Users\USER>ping -t 10.10.10.20 -f -l 4000

Ping 10.10.10.20 4000바이트 데이터 사용:
10.10.10.20의 응답: 바이트=4000 시간=3ms TTL=128
10.10.10.20의 응답: 바이트=4000 시간=4ms TTL=128
10.10.10.20의 응답: 바이트=4000 시간=3ms TTL=128
10.10.10.20의 응답: 바이트=4000 시간=3ms TTL=128
```
### BCM 3828G
