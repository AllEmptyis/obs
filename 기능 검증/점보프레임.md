...
```
## 실습3_rtk 2254GXP
- 2254 스위치 한 대에 호스트(pc) 2대를 연결하여 ping test
- 스위치 버전
	- v3.2.17
- 설정
```
...
Interface ge2
  Hardware is Ethernet  Current HW addr: 0006.c471.39c3
  Physical:0006.c471.39c3  Logical:(not set)
  index 6 snmp-index 102 metric 1 mtu 9000 arp ageing timeout 3000
  <UP,BROADCAST,RUNNING,MULTICAST>
  VRF Binding: Not bound
  Bandwidth 1g

PC: 10.10.10.10, 10.10.10.20
...
ip6gre0               unassigned      administratively down down
loopback              127.0.0.1       up                    up
mgmtcs                unassigned      up                    up
mon                   unassigned      up                    up
sit0                  unassigned      administratively down down
smon                  unassigned      up                    up
vlan1                 10.10.10.1      up                    up
```
- 스위치 to PC
	- 스위치의 mtu=1500 , 실패
```
bash-4.4# ping -s 4000 -M do 10.10.10.10
PING 10.10.10.10 (10.10.10.10) 4000(4028) bytes of data.
ping: local error: Message too long, mtu=1500
ping: local error: Message too long, mtu=1500
ping: local error: Message too long, mtu=1500
^C
...
bash-4.4# ping -s 1000 -M do 10.10.10.10
PING 10.10.10.10 (10.10.10.10) 1000(1028) bytes of data.
1008 bytes from 10.10.10.10: icmp_seq=1 ttl=128 time=0.000 ms
1008 bytes from 10.10.10.10: icmp_seq=2 ttl=128 time=0.000 ms
1008 bytes from 10.10.10.10: icmp_seq=3 ttl=128 time=0.000 ms
^C
--- 10.10.10.10 ping statistics ---
