...
sendmail: 메일서버에서 메일을 송수신 (smtp) 
dovecot: pop3/imap 프로토콜을 사용해서 웹메일을 통해 메일을 받고 읽을 수 있도록 함
pop3: 메일 서버에서 메일 가져온 즉시 삭제
imap: 메일 서버와 메일 앱 동기화
->메일 서버에 있는 메일을 사용자가 앱에서 읽을 수 있도록 가져오는 역할 
# 데몬
## Sendmail
### 주요 설정 파일
